...
Avantis is a recently founded asset manager run by former DFA employees. [Their funds](https://www.avantisinvestors.com/content/avantis/en/investments.html) are also of the highest quality, and for now they offer a greater number of publicly accessible funds. Their bond funds are distinguished by using information in the current [yield curve](https://www.investopedia.com/terms/y/yieldcurve.asp) to enhance returns, an approach explained in [this video](https://www.youtube.com/watch?v=toUmwo-mhjM&ab_channel=TheRationalReminderPodcast).

Avantis's US small cap value ETF ([AVUV](https://www.avantisinvestors.com/content/avantis/en/investments/avantis-u-s-small-cap-value-etf.html)) is an example of a superlative product. Avantis value funds in general are arguably superior because they filter simultaneously for value and profitability. It's essential to understand that this is the kind of stock selection that is motivated by an understanding of risk factors, as opposed to the crude hodge-podge of separate value and quality funds suggested above. Some people may not be comfortable straying from household names like Vanguard and Fidelity, but we can't build the best portfolios from their funds. Among the large managers, Invesco's [RZV](https://www.invesco.com/us/financial-products/etfs/product-detail?audienceType=Investor&ticker=RZV) has the greatest [exposure](https://www.portfoliovisualizer.com/factor-analysis) to the value factor, and VIOV/IJS/SLYV, all three of which track the same index, are decent products.
