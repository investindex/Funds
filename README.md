...
BlackRock has an alternative to IUSV. This fund, [VLUE](https://www.ishares.com/us/products/251616/ishares-msci-usa-value-factor-etf), has a smaller number of holdings and a stronger value tilt than IUSV. It is expected to exaggerate the value premium, outperforming the market more when the value premium is positive and underperforming more when the premium is negative. It stands to reason that in the long run VLUE will probably outperform IUSV, although with higher volatility and higher random risk due to less diversification.
