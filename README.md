...
See the footnote for discussion of additional funds and other approaches to achieving factor tilts.<sup id="fn1">[1](#f1)</sup> My preferred approach is exhibited in the example portfolio section, and it's substantively different than the portfolios above.
...
Avantis's US small cap value ETF ([AVUV](https://www.avantisinvestors.com/content/avantis/en/investments/avantis-u-s-small-cap-value-etf.html)) is an example of a superlative product that I favor over any other. (RZV is great too, and I'm not saying that VIOV/IJS/SLYV, all three of which track the same index, are bad products.) Avantis value funds in general are arguably superior because they filter for profitability. This is the kind of stock selection that is motivated by an understanding of risk factors, as opposed to the crude hodge-podge of separate value and quality funds. Some people may not be comfortable with straying from household names like Vanguard and Fidelity, but the largest asset managers unfortunately do not offer the best products.
